...
celery = Celery(
    ...
    include=[
        "services.workers.tasks.website",
        "services.workers.tasks.files",
        "services.workers.tasks.ai",
    ],
)
...
celery.conf.update(
    ...
    task_routes={
        "services.workers.tasks.website.*": {"queue": "website"},
        "services.workers.tasks.files.*": {"queue": "file"},
        "services.workers.tasks.ai.*": {"queue": "ai"},
    },
