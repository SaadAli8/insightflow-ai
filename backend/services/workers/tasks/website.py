...
from models import Job, JobStatus, Website
from config.database import SessionLocal
from services import storage
from services.events import Event, publish
from services.workers.celery_app import celery
from services.workers.ratelimit import domain_gate
from services.workers.scraper import fetch_clean_text

log = get_logger("task.website")


@celery.task(bind=True, name="services.workers.tasks.website.analyze_website",
...
def analyze_website(self: Task, job_id: str):
    ...
    try:
        ...
        celery.send_task("services.workers.tasks.ai.run_ai_analysis", args=[job.id], queue="ai")
