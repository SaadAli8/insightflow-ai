...
from models import File, Job, JobStatus
from config.database import SessionLocal
from services import storage
from services.events import Event, publish
from services.workers.celery_app import celery
from services.workers.extractors import extract_text

log = get_logger("task.file")


@celery.task(bind=True, name="services.workers.tasks.files.process_file",
