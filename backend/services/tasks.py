...
# Task names must match @celery.task(name=...) in services.workers.tasks.
ANALYZE_WEBSITE = "services.workers.tasks.website.analyze_website"
PROCESS_FILE = "services.workers.tasks.files.process_file"
